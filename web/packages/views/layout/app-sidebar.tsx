...
const personalNav: { key: NavKey; i18nKey: string; icon: typeof Inbox }[] = [
  { key: "inbox", i18nKey: "nav.inbox", icon: Inbox },
  { key: "myIssues", i18nKey: "nav.myIssues", icon: CircleUser },
];

const workspaceNav: { key: NavKey; i18nKey: string; icon: typeof Inbox }[] = [
  { key: "issues", i18nKey: "nav.issues", icon: ListTodo },
  { key: "projects", i18nKey: "nav.projects", icon: FolderKanban },
  { key: "autopilots", i18nKey: "nav.autopilot", icon: Zap },
  { key: "agents", i18nKey: "nav.agents", icon: Bot },
];

const configureNav: { key: NavKey; i18nKey: string; icon: typeof Inbox }[] = [
  { key: "runtimes", i18nKey: "nav.runtimes", icon: Monitor },
  { key: "skills", i18nKey: "nav.skills", icon: BookOpenText },
  ...
  return (
      <Sidebar variant="inset">
        ...
        <SidebarContent>
          ...
          <SidebarGroup>
            <SidebarGroupLabel>{t("nav.configure")}</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu className="gap-0.5">
