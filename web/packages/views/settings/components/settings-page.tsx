...
const accountTabDefs = [
  { value: "profile", i18nKey: "settings.profile", icon: User },
  { value: "appearance", i18nKey: "settings.appearance", icon: Palette },
  { value: "tokens", i18nKey: "settings.apiTokens", icon: Key },
];

const workspaceTabDefs = [
  { value: "workspace", i18nKey: "settings.general", icon: Settings },
  { value: "repositories", i18nKey: "settings.repositories", icon: FolderGit2 },
  { value: "labs", i18nKey: "settings.labs", icon: FlaskConical },
  { value: "members", i18nKey: "settings.members", icon: Users },
];
