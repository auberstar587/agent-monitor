      ...
      <div className="flex flex-1 min-h-0 flex-col gap-4 p-6">
        ...
        {showEmpty ? (
          ...
          <div className="flex flex-1 min-h-0 flex-col overflow-hidden rounded-lg border bg-background">
            ...
            />
            {filtered.length === 0 ? (
              <NoMatchesState search={search} healthFilter={healthFilter} scope={scope} bootstrapping={bootstrapping} t={t} />
            ) : (
              <RuntimeList
                runtimes={filtered}
...
function CardToolbar({
  ...
  return (
    <div className="flex h-12 shrink-0 items-center gap-2 border-b px-4">
      ...
      <ScopeSegment value={scope} onChange={setScope} t={t} />
      <Tooltip>
        <TooltipTrigger
          render={
...
function EmptyState({ t }: { t: (key: string) => string }) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <h2 className="mt-4 text-base font-semibold">{t("runtimes.empty.noRuntimes")}</h2>
...
function NoMatchesState({
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-2 px-4 py-16 text-center text-muted-foreground">
      ...
      <p className="text-sm">{t("runtimes.empty.noMatches")}</p>
