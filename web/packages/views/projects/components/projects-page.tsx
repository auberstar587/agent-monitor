...
function ProjectRow({ project, t }: { project: Project; t: (key: string) => string }) {
        ...
        <PopoverContent align="start" className="w-52 p-0">
          ...
          <div className="p-1 max-h-60 overflow-y-auto">
            ...
            {filteredMembers.length > 0 && (
              <>
                <div className="px-2 pt-2 pb-1 text-xs font-medium text-muted-foreground uppercase tracking-wider">{t("projects.table.members")}</div>
            ...
            {filteredAgents.length > 0 && (
              <>
                <div className="px-2 pt-2 pb-1 text-xs font-medium text-muted-foreground uppercase tracking-wider">{t("projects.table.agents")}</div>
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-muted-foreground">
            ...
            <p className="text-sm">{t("projects.empty.noProjects")}</p>
          ...
          <>
            ...
            <div className="sticky top-0 z-[1] flex h-8 items-center gap-2 border-b bg-muted/30 px-5 text-xs font-medium text-muted-foreground">
              {/* Icon spacer + Name */}
              <span className="shrink-0 w-[24px]" />
              <span className="min-w-0 flex-1">{t("projects.title")}</span>
              <span className="w-24 text-center shrink-0">{t("projects.table.priority")}</span>
              <span className="w-28 text-center shrink-0">{t("projects.table.status")}</span>
              <span className="w-24 text-center shrink-0">{t("projects.table.progress")}</span>
              <span className="w-10 text-center shrink-0">{t("projects.table.members")}</span>
              <span className="w-20 text-right shrink-0">{t("projects.table.created")}</span>
            </div>
            {/* Rows */}
